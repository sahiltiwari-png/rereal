          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+971506040777" className="hover:text-white">+971 5060 40777</a>
              </li>
              <li className="flex items-start gap-2">
                <Mail size={14} className="text-gray-400 mt-0.5" />
                <a href="mailto:Info@trivararealestate@gmail.com" className="hover:text-white">Info@trivararealestate@gmail.com</a>
              </li>
              <li className="flex items-start gap-2">
