...
const ReadyToMovePage: React.FC = () => {
  ...
  useEffect(() => {
    const data: Property[] = [
      {
        id: 'rtm-1',
        title: 'Elegant by Damac in Jumeirah Village Circle',
        location: 'JVC',
        price: 1250000,
        bedrooms: 2,
        bathrooms: 2,
      ...
      {
        id: 'rtm-2',
        title: 'Emaar Villa – Arabian Ranches',
      ...
      {
        id: 'rtm-8',
        title: 'Community Apartments – JVC',
        location: 'JVC',
        price: 980000,
        bedrooms: 1,
        bathrooms: 1,
  ...
  // Filter removed on request; listings show all ready-to-move properties.
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative w-full">
        <img
          src="/readytomove.webp"
          alt="Ready To Move In"
          className="w-full h-[220px] sm:h-[320px] md:h-[380px] object-cover"
        />
        <div className="absolute inset-0 bg-black/30" />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-white text-2xl sm:text-3xl md:text-4xl font-bold">Ready To Move In</h1>
          <div className="mt-3">
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full" style={{ backgroundColor: brand.primary, color: 'white' }}>
              ...
              <span aria-current="page" className="font-semibold">Ready To Move In</span>
            </div>
          </div>
        </div>
      </section>
